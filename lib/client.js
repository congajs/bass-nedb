	...
	find(metadata, collection, id, cb) {
		...
		this.db.collection(collection, function(err, coll) {
			...
			coll.findOne(cond, function(err, item) {
				...
				self.logger.debug('[bass-nedb] - find [' + collection + ']: ' + id + ' : ' + time + 'ms');
	...
	findByQuery(metadata, collection, query, cb) {
		...
		this.db.collection(collection, function(err, coll) {
			...
			cursor.exec(function(err, docs) {
				...
				that.logger.debug('[bass-nedb] - findByQuery [' + collection + ']: ' + JSON.stringify(query) + ' : ' + time + 'ms');
	...
	findBy(metadata, collection, criteria, sort, skip, limit, cb) {
		...
		this.db.collection(collection, function(err, coll) {
			...
			cursor.exec(function(err, docs) {
				...
				that.logger.debug('[bass-nedb] - findBy [' + collection + ']: ' + JSON.stringify(criteria) + ' : ' + time + 'ms');
